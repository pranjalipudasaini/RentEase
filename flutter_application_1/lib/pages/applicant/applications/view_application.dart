        ...
        child: Column(
          ...
          children: [
            ...
            Text(
                ...
                style: TextStyle(fontSize: 18)),
            SizedBox(height: 10),
            Text('Employer Name: ${application['employerName'] ?? 'N/A'}',
                style: TextStyle(fontSize: 18)),
            SizedBox(height: 10),
            Text('Job Title: ${application['jobTitle'] ?? 'N/A'}',
                style: TextStyle(fontSize: 18)),
            SizedBox(height: 10),
            Text('Monthly/Annual Income: ${application['income'] ?? 'N/A'}',
                style: TextStyle(fontSize: 18)),
            SizedBox(height: 10),
            Text(
                'Previous/Current Landlord Name: ${application['landlordName'] ?? 'N/A'}',
                style: TextStyle(fontSize: 18)),
            SizedBox(height: 10),
